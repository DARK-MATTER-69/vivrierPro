      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white/95 backdrop-blur rounded-2xl shadow-2xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="p-3 bg-green-600 rounded-2xl mb-3 shadow-lg">
              <Wheat className="h-8 w-8 text-white" />
            </div>
            <h1 className="text-2xl font-bold text-slate-900">
              Vivrier<span className="text-green-600">Pro</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="w-full border border-slate-300 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full border border-slate-300 rounded-xl px-4 py-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className={cn(
                ...
                loading
                  ...
                  : 'bg-green-600 hover:bg-green-700 active:scale-[0.98] shadow-lg shadow-green-600/25'
              )}
            >
              {loading
            ...
            <div className="grid grid-cols-3 gap-2 text-center text-xs">
              {[
                ...
                <div key={r.role} className="p-2 rounded-lg bg-slate-50">
                  <span className={cn('inline-block px-2 py-0.5 rounded-full text-xs font-medium mb-1', r.color)}>
                    {r.role}
                  </span>
