...
// ✅ Utilise un nom d'icône (string) au lieu du composant directement
// → évite l'erreur "Functions cannot be passed to Client Components"
...
export default function StatsCard({ label, value, icon, color, bg, change }: StatsCardProps) {
  const Icon = ICONS[icon] ?? Package   // fallback sécurisé
  return (
